<?php
// source: C:\xampp\htdocs\nette-project\app/config/config.neon 
// source: C:\xampp\htdocs\nette-project\app/config/config.local.neon 

class Container_eea902aa11 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\FormFactory' => [1 => ['73_App_Forms_FormFactory']],
			'App\Forms\SignInFormFactory' => [1 => ['74_App_Forms_SignInFormFactory']],
			'App\Forms\SignUpFormFactory' => [1 => ['75_App_Forms_SignUpFormFactory']],
			'Nette\Security\IAuthenticator' => [1 => ['76_App_Model_UserManager']],
			'App\Model\UserManager' => [1 => ['76_App_Model_UserManager']],
			...
			'ArrayAccess' => [['application.1', 'application.3', 'application.4', 'application.5', 'routing.router']],
		...
		'services' => [
			'73_App_Forms_FormFactory' => 'App\Forms\FormFactory',
			'74_App_Forms_SignInFormFactory' => 'App\Forms\SignInFormFactory',
			'75_App_Forms_SignUpFormFactory' => 'App\Forms\SignUpFormFactory',
			'76_App_Model_UserManager' => 'App\Model\UserManager',
	...
	public function createService__73_App_Forms_FormFactory(): App\Forms\FormFactory
	{
	...
	public function createService__74_App_Forms_SignInFormFactory(): App\Forms\SignInFormFactory
	{
		$service = new App\Forms\SignInFormFactory($this->getService('73_App_Forms_FormFactory'), $this->getService('security.user'));
		return $service;
	}


	public function createService__75_App_Forms_SignUpFormFactory(): App\Forms\SignUpFormFactory
	{
		$service = new App\Forms\SignUpFormFactory($this->getService('73_App_Forms_FormFactory'), $this->getService('76_App_Model_UserManager'));
		return $service;
	}


	public function createService__76_App_Model_UserManager(): App\Model\UserManager
	{
	...
	public function createServiceAnnotations__cache__annotations(): Doctrine\Common\Cache\Cache
	{
		...
		$service->setNamespace('Kdyby_annotations.cache.annotations_eb5842cc');
		return $service;
	}
	...
	public function createServiceApplication__4(): App\Presenters\SignPresenter
	{
		$service = new App\Presenters\SignPresenter(
			$this->getService('74_App_Forms_SignInFormFactory'),
			$this->getService('75_App_Forms_SignUpFormFactory')
		);
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
		...
		$service->invalidLinkMode = 1;
		$service->onStartup = $this->getService('events.manager')->createEvent(['App\Presenters\SignPresenter', 'onStartup'], $service->onStartup, null, false);
		$service->onShutdown = $this->getService('events.manager')->createEvent(['App\Presenters\SignPresenter', 'onShutdown'], $service->onShutdown, null, false);
		$service->onAnchor = $this->getService('events.manager')->createEvent(['App\Presenters\SignPresenter', 'onAnchor'], $service->onAnchor, null, false);
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__dbalResult(): Doctrine\Common\Cache\Cache
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.dbalResult_eb5842cc');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__hydration(): Doctrine\Common\Cache\Cache
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.hydration_eb5842cc');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__metadata(): Doctrine\Common\Cache\Cache
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.metadata_eb5842cc');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__ormResult(): Doctrine\Common\Cache\Cache
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.ormResult_eb5842cc');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__query(): Doctrine\Common\Cache\Cache
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.query_eb5842cc');
		return $service;
	}
	...
	public function createServiceDoctrine__daoFactory(): Kdyby\Doctrine\EntityDaoFactory
	{
		return new class ($this) implements Kdyby\Doctrine\EntityDaoFactory {
			...
			public function __construct(Container_eea902aa11 $container)
			{
	...
	public function createServiceDoctrine__default__driver__Kdyby_Doctrine__annotationsImpl(): Doctrine\Common\Persistence\Mapping\Driver\MappingDriver
	{
		$service = new Doctrine\ORM\Mapping\Driver\AnnotationDriver(
			...
			['C:\xampp\htdocs\nette-project\vendor\kdyby\doctrine\src\Kdyby\Doctrine\DI/../Entities']
		);
		return $service;
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('76_App_Model_UserManager'));
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('C:\xampp\htdocs\nette-project\app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\nette-project\vendor\kdyby\doctrine\src\Kdyby\Doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\nette-project\vendor\doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\nette-project\app/../temp/proxies';
	}
}
