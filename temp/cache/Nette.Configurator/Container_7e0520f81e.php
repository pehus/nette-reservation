...
class Container_7e0520f81e extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\Facades\PlaceFacade' => [1 => ['72_App_Model_Facades_PlaceFacade']],
			'App\Model\Facades\ReservationFacade' => [1 => ['73_App_Model_Facades_ReservationFacade']],
		...
		'services' => [
			'72_App_Model_Facades_PlaceFacade' => 'App\Model\Facades\PlaceFacade',
			'73_App_Model_Facades_ReservationFacade' => 'App\Model\Facades\ReservationFacade',
	...
	public function createService__72_App_Model_Facades_PlaceFacade(): App\Model\Facades\PlaceFacade
	{
	...
	public function createService__73_App_Model_Facades_ReservationFacade(): App\Model\Facades\ReservationFacade
	{
	...
	public function createServiceApplication__3(): App\Presenters\HomepagePresenter
	{
		...
		$service->reservationFacade = $this->getService('73_App_Model_Facades_ReservationFacade');
		$service->placeFacade = $this->getService('72_App_Model_Facades_PlaceFacade');
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\nette-project\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	public function createServiceDoctrine__daoFactory(): Kdyby\Doctrine\EntityDaoFactory
	{
		return new class ($this) implements Kdyby\Doctrine\EntityDaoFactory {
			...
			public function __construct(Container_7e0520f81e $container)
			{
